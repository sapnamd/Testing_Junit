...
class SpringBootRestServiceApplicationTests {
	...
	public void checkBuildIDLogic()
	{
		...
		//assertEquals is used to compaire expected value with output value.
	...
	public void addBookTest()
	{
		...
		//above or below line code comment line 49 or 51 and 56 or 57 respectively
	...
	public void getBookByAuthorTest() throws Exception
	{
		...
		this.mockMvc.perform(get("/getBooks/author").param("authorname","Swapna"))
	...
	//.andExpect(content().json("{\"book_name\":\"Spring\",\"id\":\"rain322\",\"isbn\":\"rain\",\"aisle\":322,\"author\":\"Thanu\"}"));
	}
